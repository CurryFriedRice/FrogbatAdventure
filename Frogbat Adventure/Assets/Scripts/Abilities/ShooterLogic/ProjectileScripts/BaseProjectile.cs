...
public class BaseProjectile : MonoBehaviour
{
    ...
    public virtual void NormalizeFields()
    {
        if (MyOrigin == null)
        {
            if (transform.parent != null) MyOrigin = transform.parent.gameObject;
            else MyOrigin = transform.gameObject;
        }
        AngledDirection = new Vector3(MyOrigin.transform.right.x * MyOrigin.transform.localScale.x, MyOrigin.transform.right.y, 0);
